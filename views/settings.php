...
<div id="bootmanager" class="uk-width-1-1 uk-width-xlarge-3-4 uk-container-center" riot-view>
    ...
    <div class="uk-panel uk-text-right">
        ...
        <i class="uk-margin-right uk-icon-ambulance" title="{ App.i18n.get('Module exists in two different folders. You should delete one of them. Cockpit prevents itself from breaking, because it doesn\'t load doubled addons, but it\'s hard guess, which one is loaded.') }" data-uk-tooltip></i>
